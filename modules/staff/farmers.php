...
if($_POST){
  if(isset($_POST['username']) && isset($_POST['phone']) && isset($_POST['email']) && isset($_POST['password']) && isset($_POST['route'])){
    
    $user->name = $_POST['username'];
    $user->password = $_POST['password'];
    $user->phone = $_POST['phone'];
    $user->email = $_POST['email'];
    $user->route = $_POST['route'];
    $user->access_right = 2;
    ...
    $account->farmer_id = $db->lastInsertId();

    $accounts_initialised = $account->initialiseAccount();

    if($user_added && $accounts_initialised){
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div class="container-fluid py-4">
      ...
      <div class="row mb-4">
        ...
        <div class="col-6 mx-auto mb-xl-0 mb-4">
          <div class="card">
            ...
            <div class="row p-4">
                <div class="col-10">
                  ...
                  <button class="btn bg-gradient-dark m-4" id="add-farmer" type="submit">Save</button>
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Farmers table</h6>
              </div>
            </div>
                  ...
                  <tbody>
                    ...
                    <?php
                      ...
                      if($num > 0){
                        ...
                        <a href='./editfarmer.php?userid={$id}' class='text-secondary fixed-plugin-button font-weight-bold text-xs' data-toggle='tooltip' data-original-title='Edit user'>
                            Edit
                          </a>
                        </td>
