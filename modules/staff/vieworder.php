...
$ordered_input->order_id = isset($_GET["orderid"]) ? $_GET['orderid'] : exit;
...
$total_ordered_inputs = $ordered_input->readAllDeliveredOrderedInputs();
          ...
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                ...
                <h4 class="mb-0"><?php echo $total_ordered_inputs;?></h4>
              </div>
            </div>
            <hr class="dark horizontal my-0">
            <div class="card-footer p-3">
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Ordered Items</h6>
              </div>
            </div>
                ...
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    <?php 
                      ...
                      $stmt = $ordered_input->readAllOrderedInputsByFarmer();
                      ...
                      if($stmt->rowCount() > 0){
                        while($row = $stmt->fetch(PDO::FETCH_ASSOC)){
                          ...
                          <td class='align-middle text-center'>
                            <span class='text-secondary text-xs font-weight-bold'>{$name}</span>
                          </td>
                          <td class='align-middle text-center'>
                            <span class='text-secondary text-xs font-weight-bold'>{$description}</span>
                          </td>
                          <td class='align-middle text-center'>
                             <span class='text-secondary text-xs font-weight-bold'>KES. {$price}</span>
                           </td>
                          <td class='align-middle text-center'>
                            <span class='text-secondary text-xs font-weight-bold'>{$quantity}</span>
                          </td>
                          <td class='align-middle text-center'>
                            <span class='text-secondary text-xs font-weight-bold'>{$unit_of_measure}</span>
                          </td>
