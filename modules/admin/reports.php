  ...
  <p class="text-white text-bold mt-4 px-4">Muruaki Cooperative</p>
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link active text-white bg-gradient-primary" href="./reports.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
    ...
    <div class="row mb-4">
          ...
          <div class="card">
            <div class="card-header p-3 pt-2">
              <div class="pt-1 mx-6 mt-4">
                <p class="mb-0 text-capitalize">Orders</p>
              </div>
            </div>
            <hr class="dark horizontal my-0">
            <div class="card-footer p-3 d-flex justify-content-end">
              <button class="btn btn-link text-success" data-toggle="modal" data-target="#generateOrdersReport">Generate Orders Report</button>
            </div>
          </div>
        </div>
        ...
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
          <div class="card">
            <div class="card-header p-3 pt-2">
              <div class="pt-1 mx-6 mt-4">
                <p class="mb-0 text-capitalize">Inputs</p>
              </div>
            </div>
            <hr class="dark horizontal my-0">
            <div class="card-footer p-3 d-flex justify-content-end">
              <a href="../reports/admininputs.php" class="btn btn-link text-success">Generate Inputs Report</a>
            </div>
          </div>
        </div>
...
<!-- category modal -->
<div class="modal fade" id="generateOrdersReport" tabindex="-1" role="dialog"  aria-hidden="true">
  ...
  <div class="modal-dialog card" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">         
         <form action="inputs.php" method="post">
                  <div class="form-group mb-4">
                    ...
                    <input type="date" id="order-date" class="form-control"  name="category_name" required>
                  </div>
      ...
      <div class="modal-footer">
        ...
        <button type="button" id="generate-report-orders" class="btn btn-primary">Generate Report</button> </form>
      </div>
    </div>
  </div>
</div>
