                ...
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    <?php 
                      ...
                      $stmt = $order->readAllOrdersByUser();
                      ...
                      if($stmt->rowCount() > 0){
                        while($row = $stmt->fetch(PDO::FETCH_ASSOC)){
                          ...
                          switch ($status) {
                            ...
                            case 1:
                              $status_str = "<span class='badge badge-sm bg-gradient-info'>Processing</span>";
                              break;
                          ...
                          <td class='align-middle text-center'>
                             <span class='text-secondary text-xs font-weight-bold'>{$status_str}</span>
                              ...
                              <td class='align-middle'>
                                ...
                                <a href='../reports/farmerorders.php?orderid={$id}' class='text-secondary fixed-plugin-button font-weight-bold text-xs' data-toggle='tooltip' data-original-title='Edit user'>
                                  Print
                                </a>";
                                if($status != 3){
                                  echo "
                                    <button type='button' id='{$id}' style='display: inline-block; background: none; border: none;' class='text-danger fixed-plugin-button font-weight-bold text-xs cancel-order' data-toggle='modal' data-target='#cancelOrderModal'>
                                     Cancel
                                   </button>
